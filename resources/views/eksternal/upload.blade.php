...
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('eksternal.index') }}">Unit Kerja Eksternal</a></li>
    <li class="breadcrumb-item active"><a href="{{ route('eksternal.upload') }}">Import</a></li>
@endsection
...
@section('header_right')
    ...
    <a href="{{ route('eksternal.index') }}" class="btn btn-white tx-montserrat tx-semibold"><i data-feather="arrow-left" class="wd-10 mg-r-5"></i> Kembali</a>
@endsection
...
@section('content')
    <div class="col-sm-12 col-lg-12 mg-b-10">
        ...
        <div class="card bg-white">
            <div class="card-body">
                <form action="{{ route('eksternal.upload.post') }}" method="post" enctype="multipart/form-data">
                    @csrf
    ...
    <div class="modal fade effect-scale" id="confirm" tabindex="-1" role="dialog" aria-labelledby="confirm" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content tx-14 bg-white">
                <form action="{{ route('eksternal.truncate') }}" method="post">
                    @csrf
